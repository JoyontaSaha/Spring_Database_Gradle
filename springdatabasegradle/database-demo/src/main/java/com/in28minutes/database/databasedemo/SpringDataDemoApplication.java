...
//		
//		logger.info("Insert ID 101 -> {}", repository.save(new Person(101, "abir", "kolkata", new Date())));
//		logger.info("Update ID 10001 -> {}", repository.save(new Person(10001, "ajoy", "pune", new Date())));
...
@SpringBootApplication
@EnableJpaRepositories("com.in28minutes.database.springdata")
public class SpringDataDemoApplication implements CommandLineRunner {
